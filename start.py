...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Створення екземплярів для зберігання ігрової статистики та панелі результатів
    ...
    def _check_play_button(self, mouse_pos):
        """Запускає нову гру після натискання кнопки Play"""
        button_clicked = self.play_button.rect.collidepoint(mouse_pos)
        if button_clicked and not self.stats.game_active:
            # Сброс ігрової статистики
            ...
            # Створення нового флотк та розміщення корабля по центру
            self._create_fleet()
    ...
    def _update_screen(self):
        ...
        # Кнопка Play відображається, коли гра не активна
